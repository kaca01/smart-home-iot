    ...
    render() {
        return (
            <div>
                ...
                <iframe src="http://localhost:3000/d-solo/dced5fb4-e93d-40d2-96bb-85bc7270a2d5/odbrana-3?orgId=1&from=1705939217638&to=1705960817638&panelId=2&theme=light" width="100%" height="600px" frameborder="0"></iframe>            </div>
        )
    }
};